  ...
  orderInfo = [
      {
          ...
          "Email": this.LoginService.myAccountProfileInfo[0].ProfileInfo.email,
          "Name": this.LoginService.myAccountProfileInfo[0].ProfileInfo.firstName+' '+this.LoginService.myAccountProfileInfo[0].ProfileInfo.lastName
      }
  ]
